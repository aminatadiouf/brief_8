...
<form action="/register/store" method="post">
  ...
  <div class="row justify-content-around">
    <div class="card   mt-5 w-25 h-50">
            <fieldset>
              <legend>Formulaire d'inscription pour client</legend>
              ...
              <div class="form-group">
                <label for="exampleInputEmail1" class="form-label mt-4">Numero de telephone</label>
                <input type="string" class="form-control" name="tel" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <div class="form-group">
                ...
                <div class="form-group">
                <label for="exampleInputPassword1" class="form-label mt-4">ConfirmePassword</label>
                <input type="password" class="form-control" name="Confirmed_password" id="password" placeholder="Password" autocomplete="off">
              </div>
